...
// WARNING: All enums changes MUST be mirrored for the other languages!
// WARNING: SchemaType methods use hardcoded enums indexes, review them after any changes to the enums
...
function getStaticByteLength(SchemaType schemaType) pure returns (uint256) {
  ...
  if (index < 97) {
    // SchemaType enums elements are cyclically ordered for optimal static length lookup
